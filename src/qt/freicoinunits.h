#ifndef CALCOINUNITS_H
#define CALCOINUNITS_H
...
/** Calcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for dropdown selection boxes.
*/
class CalcoinUnits: public QAbstractListModel
{
public:
    explicit CalcoinUnits(QObject *parent);
...
typedef CalcoinUnits::Unit CalcoinUnit;

#endif // CALCOINUNITS_H
